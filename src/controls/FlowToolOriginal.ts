type ModuleType = 'Home' | 'Other';

export class DrawFlowTestModel {
...
export default class FlowToolOriginal {
    ...
    public DrawFlow: DrawFlowTestModel = {
        module: 'Home',
        data: {}
    }
    ...
    load() {
        ...
        for (var key in this.DrawFlow.data) {
            this.addNodeImport(this.DrawFlow.data[key], this.precanvas);
        }
    ...
    removeNodeInput(id: any, input_class: any) {
      ...
      nodeUpdates.forEach((itemx: any, i: any) => {
        this.drawflow.drawflow[moduleName].data[itemx.node].outputs[itemx.input].connections.forEach((itemz: any, g: any) => {
            if(itemz.node == id) {
    ...
    removeNodeOutput(id: any, output_class: any) {
      var moduleName: any = this.getModuleFromNodeId(id)
      const infoNode: any = this.getNodeFromId(id)
      if(this.module === moduleName) {
      ...
      nodeUpdates.forEach((itemx: any, i: any) => {
        this.drawflow.drawflow[moduleName].data[itemx.node].inputs[itemx.output].connections.forEach((itemz: any, g: any) => {
            if(itemz.node == id) {
    ...
    removeSingleConnection(id_output: any, id_input: any, output_class: any, input_class: any) {
      ...
      if(nodeOneModule === nodeTwoModule) {
        ...
        // Check connection exist
        var exists = this.drawflow.drawflow[nodeOneModule].data[id_output].outputs[output_class].connections.findIndex(function(item: any,i: any) {
        ...
        if(exists > -1) {
          ...
          var index_out = this.drawflow.drawflow[nodeOneModule].data[id_output].outputs[output_class].connections.findIndex(function(item: any,i: any) {
            return item.node == id_input && item.output === input_class
          });
          this.drawflow.drawflow[nodeOneModule].data[id_output].outputs[output_class].connections.splice(index_out,1);
  
          var index_in = this.drawflow.drawflow[nodeOneModule].data[id_input].inputs[input_class].connections.findIndex(function(item: any,i: any) {
