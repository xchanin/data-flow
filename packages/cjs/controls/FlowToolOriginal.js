...
exports.DrawFlowTestModel = void 0;
class DrawFlowTestModel {
    constructor(m, d) {
        this.module = m;
        this.data = d;
    }
}
exports.DrawFlowTestModel = DrawFlowTestModel;
class FlowToolOriginal {
    ...
    addNode(name, num_in, num_out, ele_pos_x, ele_pos_y, classoverride, data, html, typenode = false) {
        ...
        if (typenode === false) {
            ...
            if (parseInt(this.render.version) === 3) {
                ...
                // Vue 2
                let wrapper = new this.render(Object.assign({ parent: this.parent, render: (h) => h(this.noderegister[html].html, { props: this.noderegister[html].props }) }, this.noderegister[html].options)).$mount();
                //
    ...
    addNodeImport(dataNode, precanvas) {
        ...
        if (dataNode.typenode === false) {
            ...
            if (parseInt(this.render.version) === 3) {
                ...
                //Vue 2
                let wrapper = new this.render(Object.assign({ parent: this.parent, render: (h) => h(this.noderegister[dataNode.html].html, { props: this.noderegister[dataNode.html].props }) }, this.noderegister[dataNode.html].options)).$mount();
                content.appendChild(wrapper.$el);
            }
        }
...
exports.default = FlowToolOriginal;
