...
exports.DragItemsTemplates = void 0;
class DragItemsTemplates {
    static MENU_TEMPLATES(callback) {
        return [
            {
                ClassList: ['drag-item'],
                DataNode: 'facebook',
    ...
    static FLOW_DRAG_ITEMS(callback) {
        return [
            {
                ClassList: ['drag-item'],
                DataNode: 'request',
...
exports.DragItemsTemplates = DragItemsTemplates;
