...
export const TestNapkinIDEFlow = {
    Nodes: [
        {
            ID: '1',
            Type: 'request',
...
ConstantUtils.NAPKIN_IDE_MODULE_DATA = {
    ...
    Data: TestNapkinIDEFlow.Nodes.map((node) => {
        ...
        const inputs = (_a = TestNapkinIDEFlow.Edges) === null || _a === void 0 ? void 0 : _a.filter((edge) => edge.ID === node.ID).map((edge) => {
            return edge.Inputs;
        });
        const outputs = (_b = TestNapkinIDEFlow.Edges) === null || _b === void 0 ? void 0 : _b.filter((edge) => edge.ID === node.ID).map((edge) => {
            return edge.Outputs;
        });
        return {
